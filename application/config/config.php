...
|
*/
if ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || (!empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https') || (!empty($_SERVER['HTTP_X_FORWARDED_PORT']) && $_SERVER['HTTP_X_FORWARDED_PORT'] == 443)) {
    $protocol = 'https';
} else {
    $protocol = 'http';
}
$config['base_url'] = $protocol . '://' . $_SERVER['HTTP_HOST'] . '/' . HTTP;
...
|
*/
$config['encryption_key'] = 'E|)|V|Bac|<enc|';
