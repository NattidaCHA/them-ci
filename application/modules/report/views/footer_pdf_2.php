...
<div class="pdf">
	<div class="content">
		<div class="footer">
			...
			<?php if (($data->report->total_page == 1 && $data->report->total_page == $data->index  && $data->report->last_count < 11) || ($data->report->total_page != 1 && $data->report->total_page == $data->index && $data->report->last_count < 21)) { ?>
