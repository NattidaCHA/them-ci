...
<div style="border-collapse:collapse; border-left: 2px solid #cdcdcd; border-right: 2px solid #cdcdcd;">
	<div style="height: 100%;
        ...
        margin: 0;width: 530px; text-align: left;
		border-top-color: #cdcdcd;
        border-top-style: solid;
        border-bottom-width: 1px;
        border-bottom-color: #cdcdcd;
        border-bottom-style: solid;
		"><?php echo !empty($data->report->total->total_credit) ? 'มูลค่ารวมทั้งสิ้น (บาท)' : 'ยอดที่ต้องชำระ (บาท)' ?></th>
									<th colspan="3" style="padding: 0;
        margin: 0;width: 530px; text-align: right;		border-top-color: #cdcdcd;
        border-top-style: solid;
        border-bottom-width: 1px;
        border-bottom-color: #cdcdcd;
        border-bottom-style: solid;">
        ...
        margin: 0;font-size: 16px;border-collapse: collapse;
        border-spacing: 0;">
								<tbody>
									<?php if (!empty($data->report->lists)) {
										foreach ($data->report->lists as $key => $item) {
		...
		vertical-align: text-top; text-align: center;"><?php echo !empty($item->mtext) ? $item->mtext : '-' ?></th>
													<th colspan="3" style="padding: 0;
        margin: 0;font-size: 16px;
		vertical-align: text-top; text-align: right;vertical-align: text-top;"><?php echo number_format($item->mnetamt, 2); ?></th>
												</tr>
									<?php
											}
										}
        ...
        border-bottom-width: 1px;
        border-bottom-color: #222;
        border-bottom-style: solid">ยอดที่ต้องชำระ (บาท)</td>
										<th style="padding: 0;
        margin: 0;text-align: right;        border-top-color: #222;
        border-top-style: solid;
        border-bottom-width: 1px;
        border-bottom-color: #222;
        border-bottom-style: solid" colspan="3"><u><?php echo !empty($data->report->total->total_summary) ? number_format($data->report->total->total_summary, 2) : 0 ?></u></th>
									</tr>
								</thead>
							</table>
						</div>
