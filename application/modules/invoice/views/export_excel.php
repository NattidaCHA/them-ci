...
<div style="border-collapse:collapse; border-left: 2px solid #cdcdcd; border-right: 2px solid #cdcdcd;">
    <div style="height: 100%;
                    ...
                    <tr>
                        ...
                        <td colspan="4" style="">
                            <div style="display: flex;flex-direction: column;">
                                ...
                                <div style="font-size: 12px;font-weight: bold !important;"><?php echo  $data->tem['header'][0]->address; ?></div>
                                <div style="font-size: 12px;font-weight: bold !important;">โทร. <?php echo  $data->tem['header'][0]->tel; ?> โทรสาร <?php echo  $data->tem['header'][0]->tel2; ?></div>
                                <div style="font-size: 12px;font-weight: bold !important;">Tax-ID: <?php echo  $data->tem['header'][0]->tax; ?></div>
                            </div>
                        </td>
                    </tr>
                </thead>
        ...
        width: 85px;font-size: 14px;">รหัสลูกค้า :</td>
                                <td style="font-weight: bold;
        width: 200px;font-size: 14px;"><?php echo $data->report->info->mcustno; ?> <?php echo $data->report->info->mcustname; ?></td>
                                <td style="width: 10px;
        font-weight: bold;font-size: 14px;"><span>เลขที่เอกสารอ้างอิง</span>&nbsp;:&nbsp;<span style="font-weight: bold;"><?php echo $data->report->bill_info->bill_no; ?></span></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td style="font-weight: bold;
        width: 85px;font-size: 14px;">รหัสผู้แทนขาย :</td>
                                <td style="width: 200px;
        font-weight: bold;font-size: 14px;"><?php echo $data->report->info->msalegrp; ?></td>
                                <td style=" width: 120px;
        font-weight: bold;font-size: 14px;">วันที่ออกเอกสาร&nbsp;:&nbsp;<?php echo date('d.m.Y', strtotime($data->report->bill_info->created_date)); ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td style="font-weight: bold;
        width: 85px;font-size: 14px;"><span>สกุลเงิน&nbsp;:&nbsp;</td>
                                <td style="width: 200px;
        font-weight: bold;font-size: 14px;">THB&nbsp;(บาท)&nbsp;รวมภาษีมูลค่าเพิ่ม</td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td style="font-weight: bold;
        width: 85px;font-size: 14px;"><span></td>
                                <td style="width: 200px;
